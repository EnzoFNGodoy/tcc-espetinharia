...
{
    public partial class frmAddProdutosListaEntrada : Form
    {
        #region Instâncias
        ProdutoDAO prodDAO = new ProdutoDAO();
        public frmQtdProdutoEntrada telaQtdProd;
        #endregion
        ...
        public frmAddProdutosListaEntrada()
        {
            InitializeComponent();
        }

        private void frmAddProdutosListaEntrada_Load(object sender, EventArgs e)
        {
        ...
        {
            telaQtdProd = new frmQtdProdutoEntrada(Convert.ToInt32(gvExibirProdutos.Rows[gvExibirProdutos.CurrentCell.RowIndex].Cells[0].Value.ToString()));
