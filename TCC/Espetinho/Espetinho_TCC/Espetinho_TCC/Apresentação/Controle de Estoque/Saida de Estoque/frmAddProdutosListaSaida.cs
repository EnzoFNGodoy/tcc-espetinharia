...
{
    public partial class frmAddProdutosListaSaida : Form
    {
        #region Instâncias
        ProdutoDAO prodDAO = new ProdutoDAO();
        public frmQtdProdutoSaida telaQtdProd;
        #endregion
        ...
        public frmAddProdutosListaSaida()
        {
            InitializeComponent();
        }

        private void frmAddProdutosListaSaida_Load(object sender, EventArgs e)
        {
        ...
        {
            telaQtdProd = new frmQtdProdutoSaida(Convert.ToInt32(gvExibirProdutos.Rows[gvExibirProdutos.CurrentCell.RowIndex].Cells[0].Value.ToString()));
